...
dataset="prostate"
all_samples=['MEND154',"MEND156","MEND157","MEND158","MEND159","MEND160","MEND161"]  # all sample IDs in the dataset. User can choose their own dataset IDs.
test_sample="MEND156"   # One test sample Id for test
train_samples=sorted(list(set(all_samples)-set([test_sample])))
root_path="prostate cancer dataset/"
